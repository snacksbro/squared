...
const updateInterval = 500; // How often the board refreshes itself in ms
//TODO: every move update the score by one
class Game extends React.Component {
	...
	updateGameState() {
		...
		http.get("http://127.0.0.1:5000/initialize").then(
			function (res) {
				this.setState({
					game: res.data,
				});
			}.bind(this),
		); // This line is VERY important. Basically it wasn't letting me setState since it couldn't "see" 'this' yet. So I had to manually bind it so it could access this.setState. Similar to in other constructors (like Square's) where you have to bind functions to this.
	}
